...
> **This table is a SPECIFICATION. As of 2026-09-03 the Overlay installs EIGHT DETOURS,
> and they are marked ✅ across EIGHT rows** — the counts differed until this date, because a
> row is a *capability* and a detour is a *patch*, and the FG-count row rode on the
> evaluate detour; it has its own now, `sl.interposer.dll!slGetNewFrameToken`.
