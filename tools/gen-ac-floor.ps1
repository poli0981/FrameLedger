...
if ($existing -ne $header) {
    ...
    Write-Host "floor generated — $($rows.Count) families, $($fragments.Count) fragments -> $OutPath"
}
else {
    Write-Host "floor unchanged — $($rows.Count) families, $($fragments.Count) fragments"
}
