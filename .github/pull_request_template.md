...
- [ ] When this hook is unavailable the session records `N/A` rather than a fabricated value (FR-4.9), **and records why** — not merely "there is a Tier-2 path", which is always true and therefore unfalsifiable
